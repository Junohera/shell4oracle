...
LOG_INFO "TARGET_DIRECTORY: ${BACKUP_TARGET_DIRECTORY}"

# backup control file generation script
TRACE_START "BACKUP CONTROL FILE GENERATION SCRIPT"
...
LOG_INFO "$(ls $BACKUP_CONTROLFILE_PATH)"
TRACE_END
